...
# Fix the NAV data to be self-consistent
old_nav_rows = """    nav_rows = [
        # Date T: normal
        ("H001", "2024-06-28", 1.0, 1.0, 0.0, 0.0, 1.0, 1.0),
        # Holiday H: NAV drops but adjustment factor accounts for dividend/split
        ("H001", "2024-06-29", 0.952381, 1.0, -4.7619, 0.0, 1.05, 1.0),
        # Date T+1: normal growth from adjusted base
        ("H001", "2024-06-30", 0.98, 1.0, 2.8797, 0.0, 1.0, 1.0),
    ]"""

new_nav_rows = """    nav_rows = [
...
print("Fixed NAV data in test file")